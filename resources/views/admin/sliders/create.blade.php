<x-admin-layout title="Nuevo Slider" :breadcrumb="[
    [
        'name' => 'Inicio',
...
@endpush
    ...
    <x-slot name="action">
        <a href="{{ route('admin.sliders.index') }}"
            class="text-white bg-red-600 hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-blue-600 dark:focus:ring-blue-600 ">Volver</a>
    </x-slot>
    <div class="flex justify-between heading py-5">
        <h1 class="text-2xl font-extrabold text-gray-800">Nuevo Slider</h1>
    </div>
                        ...
                        <div id="desktop" class="tab-content active transition">
                            <div class="relative">
                                ...
                                <div class="mt-4 absolute top-8 right-8">
                                    <label class="file-label bg-white px-4 py-2 rounded-lg cursor-pointer transition flex items-center">
                        ...
                        <div class="flex  flex-wrap -mx-2">
                            <div class="mb-4 px-2 w-full">
                                <div class="icon-wrapper">
                                    ...
                                    <x-label for="title" class="form-label">Título del Slider</x-label>
                                </div>
                                <x-input value="{{ old('title') }}" x-model="title" class="form-input w-full" name="title"
                                    placeholder="Ingrese el nombre del slider"></x-input>
                            </div>
        
                            <div class="mb-5 px-2 w-full">
                                <div class="icon-wrapper">
                                    <i class="fa-solid fa-paragraph text-gray-500"></i>
                                    <x-label for="paragraph" class="form-label">Descripcion corta</x-label>
                                </div>
                                <textarea name="paragraph" rows="4"
                                    class="form-input block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Escriba un extracto del slider">{{ old('paragraph') }}</textarea>
                            </div>
        
                            <div class="mb-4 px-2 w-full">
                                <div class="icon-wrapper">
                                    <i class="fa-solid fa-link text-gray-500"></i>
                                    <x-label for="link" class="form-label">Link</x-label>
                                </div>
                                <x-input name="link" value="{{ old('link') }}"
                                    ...
                                    placeholder="Ingrese el link"></x-input>
                            </div>                            
                        </div>
                    </div>
                </div>
