    ...
    <section class="contact-area pb-100">
        <div class="container">
            ...
            <div class="contact-form">
                <form id="contactAdela" method="POST" action="{{route('contacto.store')}}">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                <input type="text" name="asunto" id="asunto" value="{{old('asunto')}}"  class="form-control" required
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group">
                                <textarea name="message" class="form-control" id="message" value="{{old('message')}}"  cols="30" rows="5"
