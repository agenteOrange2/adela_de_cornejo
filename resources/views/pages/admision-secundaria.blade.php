...
@section('title', 'Admision Secundaria')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="experience-content animated">
                        ...
                        <p class="text-justify pt-3">Nuestro programa busca desarrollar las competencias de las asignaturas
                            de forma
                            integral, con un programa transversal que propicia el desarrollo de las inteligencias múltiples
                            y 100%
                            bilingüe, que permite a nuestros estudiantes ampliar su conocimiento y preparar mejor su camino
                            para el
                            futuro. Nuestro programa se complementa con clases extracurriculares como computación, educación
                            física y
                            música.
                        </p>
                        <h5>Servicios</h5>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <p class="font-italic text-muted mb-2"> Creamos situaciones centradas en el
                                                ...
                                                danza, narración,
                                                ciudadanía,
                                                jardinería, música, arte, comunicación y alfabetización.
                                            </p>

                                            ‍
                                            <p class="font-italic text-muted mb-2">Ámbitos:</p>
                                            ‍
                                            ...
                                            <p class="font-italic text-muted mb-2">
                                                ¡Estamos preparando a diseñadores del futuro!
                                            </p>
                                        </div>
                                    </div>
                                </div>
