                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="sort_direction"
                                            value="{{ request('sort_direction', 'desc') == 'asc' ? 'desc' : 'asc' }}">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center">
                            ...
                            <p class="mb-5">Debes iniciar sesión para ver los avisos. Conéctate para acceder a la información más reciente y relevante.</p>
