        ...
        <div class="container">
            <div class="page-title-content">
                <ul>
                    ...
                    <li><a href="campus-triunfo">Campus Triunfo</a></li>
                </ul>
                <h2>Campus Triunfo</h2>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg col-md-12 pt-5 pt-md-0">
                    <a href="{{ Storage::url($plantel->image_path) }}" data-toggle="lightbox" data-gallery="hidden-images" class="col-6 col-sm-6 pb-3">
