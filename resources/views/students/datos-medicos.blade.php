...
@section('title', 'Mi Cuenta - Datos Médicos')
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('mi-cuenta/calificaciones') ? 'active' : '' }}"
                            href="{{ route('student.calificaciones') }}"><i
                                class='bx bxs-alarm-exclamation'></i>Calificaciones
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('mi-cuenta/datos-medicos') ? 'active' : '' }}"
                            href="{{ route('student.datos-medicos') }}"><i class='bx bxs-alarm-exclamation'></i>Datos
                            Médicos
                        </a>
                    </li>
                </ul>
